...
const UpdatePatientType = () => {
    ...
    const getPatientById = async() => {
        const response = await fetch(`http://localhost:4000/patient-type/${id}`);
    ...
    return (
        <div>
            <h1 className="text-2xl font-bold mb-4 text-center">Detail Patient Type</h1>
...
export default UpdatePatientType;