...
const UpdateDrugType = () => {
    ...
    const getDrugById = async() => {
        const response = await fetch(`http://localhost:4000/drug-type/${id}`);
    ...
    return (
        <div>
            <h1 className="text-2xl font-bold mb-4 text-center">Detail Drug Type</h1>
