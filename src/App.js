      ...
      <Router>
        <Routes>
          <Route path='/' element={<Layout />}>
            <Route path='service-type' element={<ServiceTypePage />}></Route>
            <Route path="service-type/add" element={<AddServiceType />}></Route>
            <Route path="service-type/update/:id" element={<UpdateServiceType />}></Route>
